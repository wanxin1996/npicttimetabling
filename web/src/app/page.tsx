        ...
        <section className="min-w-0">
          ...
          <div className="mb-6 flex flex-col justify-between gap-4 sm:flex-row sm:items-end">
            <div>
              ...
              <h1 className="mt-1 text-3xl font-black tracking-tight text-slate-950">{view === "Year timetables" ? "Build the master timetable" : view === "Rules & issues" ? "Review rules and timetable issues" : "Build the scheduling foundation"}</h1>
              <p className="mt-2 max-w-2xl text-sm leading-6 text-slate-500">{view === "Year timetables" ? "Drag an unscheduled section into a weekday and whole-hour start time." : view === "Rules & issues" ? "Maintain unavailable windows and review every current warning in one place." : "Maintain teachers, student groups and rooms before importing teaching allocations or placing course sections."}</p>
            </div>
